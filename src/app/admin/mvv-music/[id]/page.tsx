...
export default function EditarMusicaPage() {
  ...
  const [form, setForm] = useState<Song | null>(null);
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-[var(--foreground)]">Editar Música</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, thumbnail: e.target.value || null })
                }
                className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
              />
            </div>
            <div>
              ...
              <input
                ...
                value={form.spotify || ""}
                onChange={(e) =>
                  setForm({ ...form, spotify: e.target.value || null })
                }
                className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
              />
            </div>
            <div>
              ...
              <input
                ...
                value={form.deezer || ""}
                onChange={(e) =>
                  setForm({ ...form, deezer: e.target.value || null })
                }
                className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
              />
            </div>
            <div>
              ...
              <input
                ...
                value={form.youtube || ""}
                onChange={(e) =>
                  setForm({ ...form, youtube: e.target.value || null })
                }
                className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
              />
            </div>
